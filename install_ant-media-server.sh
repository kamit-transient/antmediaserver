...
AMS_BASE=/home/app/antmedia
BACKUP_DIR="/home/app/antmedia-backup-"$(date +"%Y-%m-%d_%H-%M-%S")
SAVE_SETTINGS=false
...
distro () {
  ...
  if [ -f "$os_release" ]; then
    . $os_release
    msg="We are supporting Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10, Ubuntu 21.04, Ubuntu 21.10, Centos 8, Rocky Linux 8 and AlmaLinux 8"
